	...
	<body id="new-operator-body">
		<div id="new-operator-contain">
			...
			<div id="new-operator-main">
				...
				<br>
				<form method="get" action="servlet/OnlineAccountServlet" class="form-style" onsubmit="return verity()">
					<table>
						<tr>
						...
						<tr class="button-tr-style">
							<td colspan="2" class="right-td-style">
								...
								<input type="hidden" name="value" id="value" value="<%=request.getParameter("value") %>"/>
								<input type="hidden" name="discount" id="discount" value="<%=request.getParameter("discount") %>"/>						
