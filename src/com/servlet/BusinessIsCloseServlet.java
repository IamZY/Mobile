...
public class BusinessIsCloseServlet extends HttpServlet {
	customerServiceIface customerService;
	/**
	 * Constructor of the object.
	 */
	public BusinessIsCloseServlet() {
		super();
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//接受手机号判断业务是否已经开通
		System.out.println("businessisclose..............");
		...
		try {
			...
			MobilePackage mobilePackage = new MobilePackage(telnumb,bid,null,null,d);
			String result = "";
			boolean b = customerService.updatemobilepackage_end(mobilePackage);
